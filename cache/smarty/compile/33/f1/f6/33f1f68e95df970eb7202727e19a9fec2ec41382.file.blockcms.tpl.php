...
">
		...
		<ul class="toggle-footer">
			<li class="item">
					<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('newsletter'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Specials','mod'=>'blockcms'),$_smarty_tpl);?>
">
						Newsletter 
					</a>
...
">
	...
	<section class="bottom-footer col-xs-12">
		...
		<img class="logo-bot" src="/img/mrdike.png" alt="inspired by Mr. Dike">
			<?php echo smartyTranslate(array('s'=>'[1] %3$s %2$s  %1$s [/1]','mod'=>'blockcms','sprintf'=>array('SUITSURMESUR. All Rights Reserved',date('Y'),'Copyright © '),'tags'=>array('<a class="_blank" href="http://www.suitsurmesur.com">')),$_smarty_tpl);?>
