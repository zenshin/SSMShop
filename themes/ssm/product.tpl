	...
	<div class="primary_block row">
		...
		<div class="pb-center-column col-xs-12 col-sm-6">
			<div class="toggle-titles">
				<h3 class="page-product-heading main">{l s='More info'}</h3>
				<h3 class="page-product-heading details">{l s='Details & Care'}</h3>
			</div>
			...
			{if $product->description_short || $packItems|@count > 0}
				<div id="short_description_block">
					{if $product->description_short}
						<div id="short_description_content" class="rte align_justify hidden" itemprop="description">{$product->description_short}</div>
					{/if}
