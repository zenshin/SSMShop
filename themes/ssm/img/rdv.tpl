                     ...
                     <label for="time">{l s='Time'}</label>
                        <select class="form-control" name="interest">
							<option value="0">{l s='-- Choose your appointment time--'}</option>
                                ...
                                <option value="4">{l s='12:00-01:00'}</option>
                                <option value="5">{l s='01:00-02:00'}</option>
                                <option value="6">{l s='02:00-03:00'}</option>
                                <option value="6">{l s='03:00-04:00'}</option>
                                <option value="6">{l s='04:00-05:00'}</option>
                                <option value="6">{l s='05:00-06:00'}</option>
                                <option value="6">{l s='06:00-07:00'}</option>
                                <option value="6">{l s='07:00-08:00'}</option>
                                <option value="6">{l s='08:00-09:00'}</option>
						</select>   
                    </p>
                </div>
    	    </div>
